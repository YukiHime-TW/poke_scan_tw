...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _2165: x0 => x0.trustedTypes,
      _2166: (x0,x1) => { x0.src = x1 },
      _2167: (x0,x1) => x0.createScriptURL(x1),
      _2168: x0 => x0.nonce,
      _2169: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2169(f,arguments.length,x0) }),
      _2170: x0 => ({createScriptURL: x0}),
      _2171: (x0,x1) => x0.querySelectorAll(x1),
      _2172: () => new AbortController(),
      _2173: x0 => x0.abort(),
      _2174: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _2175: (x0,x1) => globalThis.fetch(x0,x1),
      _2176: (x0,x1) => x0.get(x1),
      _2177: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._2177(f,arguments.length,x0,x1,x2) }),
      _2178: (x0,x1) => x0.forEach(x1),
      _2179: x0 => x0.getReader(),
      _2180: x0 => x0.cancel(),
      _2181: x0 => x0.read(),
