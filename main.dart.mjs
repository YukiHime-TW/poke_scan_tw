...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1326: (x0,x1) => x0.getUserMedia(x1),
      _1327: x0 => x0.getSupportedConstraints(),
      _1328: x0 => x0.getVideoTracks(),
      _1329: x0 => x0.getCapabilities(),
      _1330: x0 => x0.getSettings(),
      _1331: (x0,x1,x2) => x0.setProperty(x1,x2),
      _1332: (x0,x1) => x0.append(x1),
      _1333: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1334: x0 => x0.play(),
      _1336: x0 => x0.getTracks(),
      _1337: x0 => x0.stop(),
      _1338: (x0,x1,x2) => x0.translate(x1,x2),
      _1339: (x0,x1,x2) => x0.scale(x1,x2),
      _1340: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1341: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1341(f,arguments.length,x0) }),
      _1342: (x0,x1,x2) => x0.toBlob(x1,x2),
      _1343: x0 => globalThis.URL.createObjectURL(x0),
      _1344: x0 => ({torch: x0}),
      _1345: (x0,x1) => x0.applyConstraints(x1),
      _1359: x0 => x0.load(),
      ...
      _1403: x0 => x0.call(),
      _1432: x0 => globalThis.firebase_firestore.deleteDoc(x0),
      ...
      _1441: (x0,x1,x2) => globalThis.firebase_firestore.setDoc(x0,x1,x2),
      _1442: (x0,x1) => globalThis.firebase_firestore.setDoc(x0,x1),
      _1443: (x0,x1) => globalThis.firebase_firestore.query(x0,x1),
      _1444: x0 => globalThis.firebase_firestore.getDocs(x0),
      _1445: x0 => globalThis.firebase_firestore.getDocsFromServer(x0),
      _1446: x0 => globalThis.firebase_firestore.getDocsFromCache(x0),
      _1447: x0 => globalThis.firebase_firestore.limit(x0),
      _1448: x0 => globalThis.firebase_firestore.limitToLast(x0),
      _1451: (x0,x1) => globalThis.firebase_firestore.orderBy(x0,x1),
      _1453: (x0,x1,x2) => globalThis.firebase_firestore.where(x0,x1,x2),
      _1459: (x0,x1) => x0.data(x1),
      _1463: x0 => x0.docChanges(),
      ...
      _1500: () => globalThis.firebase_firestore.or,
      _1501: () => globalThis.firebase_firestore.and,
      _1506: x0 => x0.path,
      ...
      _1598: x0 => x0.source,
      _1603: () => globalThis.firebase_firestore.startAfter,
      _1604: () => globalThis.firebase_firestore.startAt,
      _1605: () => globalThis.firebase_firestore.endBefore,
      _1606: () => globalThis.firebase_firestore.endAt,
      ...
      _2031: (t, s) => t.set(s),
      _2032: l => new DataView(new ArrayBuffer(l)),
      ...
      _2151: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _2152: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      _2186: x0 => x0.torch,
      _2187: x0 => x0.facingMode,
      _2196: (x0,x1) => x0.key(x1),
      _2197: x0 => x0.trustedTypes,
      _2198: (x0,x1) => { x0.text = x1 },
      _2199: x0 => x0.random(),
      _2200: (x0,x1) => x0.getRandomValues(x1),
      _2201: () => globalThis.crypto,
      _2202: () => globalThis.Math,
      _2205: (x0,x1) => x0.getContext(x1),
      ...
      _2218: (x0,x1,x2) => x0.recognize(x1,x2),
      _2219: x0 => x0.data,
      _2220: x0 => x0.text,
      _2221: () => globalThis.Tesseract,
      _2222: () => globalThis.document,
      _2228: (x0,x1) => { x0.height = x1 },
      _2230: (x0,x1) => { x0.width = x1 },
      _2239: x0 => x0.style,
      _2242: x0 => x0.src,
      ...
      _2265: () => globalThis.google.accounts.oauth2,
      _2270: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2270(f,arguments.length,x0) }),
      _2271: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2271(f,arguments.length,x0) }),
      _2272: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12) => ({client_id: x0,scope: x1,include_granted_scopes: x2,redirect_uri: x3,callback: x4,state: x5,enable_granular_consent: x6,enable_serial_consent: x7,login_hint: x8,hd: x9,ux_mode: x10,select_account: x11,error_callback: x12}),
      _2273: x0 => x0.code,
      _2276: x0 => x0.error,
      _2279: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2279(f,arguments.length,x0) }),
      _2280: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2280(f,arguments.length,x0) }),
      _2281: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _2282: x0 => x0.requestAccessToken(),
      _2283: (x0,x1) => x0.requestAccessToken(x1),
      _2284: (x0,x1,x2,x3,x4,x5,x6) => ({scope: x0,include_granted_scopes: x1,prompt: x2,enable_granular_consent: x3,enable_serial_consent: x4,login_hint: x5,state: x6}),
      _2285: x0 => x0.access_token,
      _2286: x0 => x0.expires_in,
      _2289: x0 => x0.token_type,
      _2292: x0 => x0.error,
      _2295: x0 => x0.type,
      _2300: () => globalThis.google.accounts.id,
      _2314: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2314(f,arguments.length,x0) }),
      ...
      _2328: x0 => x0.error,
      _2330: x0 => x0.credential,
      _2341: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _2342: f => finalizeWrapper(f, function() { return dartInstance.exports._2342(f,arguments.length) }),
      _2468: x0 => x0.style,
      _2667: (x0,x1) => { x0.nonce = x1 },
      _3040: x0 => x0.videoWidth,
      _3041: x0 => x0.videoHeight,
      _3071: x0 => x0.error,
      _3074: x0 => x0.srcObject,
      _3075: (x0,x1) => { x0.srcObject = x1 },
      _3099: (x0,x1) => { x0.autoplay = x1 },
      _3107: (x0,x1) => { x0.muted = x1 },
      _3122: x0 => x0.code,
      _3123: x0 => x0.message,
      _3702: (x0,x1) => { x0.src = x1 },
      _3704: (x0,x1) => { x0.type = x1 },
      _3708: (x0,x1) => { x0.async = x1 },
      _3710: (x0,x1) => { x0.defer = x1 },
      _3712: (x0,x1) => { x0.crossOrigin = x1 },
      _3714: (x0,x1) => { x0.text = x1 },
      _3748: (x0,x1) => { x0.width = x1 },
      _3750: (x0,x1) => { x0.height = x1 },
      _4169: () => globalThis.window,
      _4210: x0 => x0.document,
      _4213: x0 => x0.location,
      _4232: x0 => x0.navigator,
      _4236: x0 => x0.screen,
      _4494: x0 => x0.trustedTypes,
      _4495: x0 => x0.sessionStorage,
      _4496: x0 => x0.localStorage,
      _4511: x0 => x0.hostname,
      _4602: x0 => x0.geolocation,
      _4605: x0 => x0.mediaDevices,
      _4607: x0 => x0.permissions,
      _4829: x0 => x0.length,
      _6774: x0 => x0.signal,
      _6783: x0 => x0.length,
      ...
      _9297: x0 => x0.url,
      _9299: x0 => x0.status,
      _9301: x0 => x0.statusText,
      _9302: x0 => x0.headers,
      _9303: x0 => x0.body,
      _9568: x0 => x0.type,
      _9600: x0 => x0.orientation,
      _10118: x0 => x0.facingMode,
      _10193: x0 => x0.facingMode,
      _10332: x0 => x0.width,
      _10334: x0 => x0.height,
      _10417: x0 => x0.deviceId,
      _10418: x0 => x0.kind,
      _10419: x0 => x0.label,
      _11859: (x0,x1) => { x0.height = x1 },
      _12053: (x0,x1) => { x0.objectFit = x1 },
      _12183: (x0,x1) => { x0.pointerEvents = x1 },
      _12481: (x0,x1) => { x0.transform = x1 },
      _12485: (x0,x1) => { x0.transformOrigin = x1 },
      _12549: (x0,x1) => { x0.width = x1 },
      _12917: x0 => x0.name,
      _12918: x0 => x0.message,
      _13634: () => globalThis.console,
      _13660: x0 => x0.name,
      _13661: x0 => x0.message,
      _13662: x0 => x0.code,
      _13664: x0 => x0.customData,
