...
REPLACEMENTS = {
    ...
    # --- 2026-09 官方卡片頁核對補上的異體字（逐名，避免整字替換誤傷）---
    "火暴": "火爆",              # 火暴猴/火暴獸 -> 火爆猴/火爆獸
    "卷卷耳": "捲捲耳",
    "保姆": "保母",              # 保姆蟲、保姆曼波
    "拳海蔘": "拳海參",
    "引力山嶽": "引力山岳",
    ...
    "改造之鎚": "改造之錘",
    "多邊獸2": "多邊獸Ⅱ",
    "N的PP提升劑": "N的ＰＰ提升劑",  # 官方此卡用全形ＰＰ
    # 以下三組原本是整字替換規則，官方核對後方向相反，改為逐名：
    "神秘珍寶": "神祕珍寶",
    "巨大爐灶": "巨大爐竈",
    "火竈面具": "火灶面具",        # 保留原本意圖（厄鬼椪 火灶面具）
    "台北的皮卡丘": "臺北的皮卡丘",
}
